...
PatientMonitoringDummy::PatientMonitoringDummy() : Node("PatientMonitoringDummy")
{
    ...
    set_condition_subscription_ = create_subscription<std_msgs::msg::String>("SetCondition", 10, std::bind(&PatientMonitoringDummy::set_condition_callback_, this, std::placeholders::_1));
}

void PatientMonitoringDummy::set_condition_callback_(const std_msgs::msg::String::SharedPtr msg)
{
    if (msg->data == "good")
    {
